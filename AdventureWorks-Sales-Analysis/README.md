...
### Excel Dashboard
<img width="1149" height="603" alt="Excel-Dashbaord" src="https://github.com/user-attachments/assets/34680e42-1d5e-48ef-a6d6-05c220bdc3d7" />

### Power BI Dashboard
<img width="1189" height="681" alt="PowerBI-Dashboard" src="https://github.com/user-attachments/assets/f67c1065-6192-4c15-a4b0-6220afc01311" />

### Tableau Dashboard
<img width="1402" height="688" alt="Tableau-Dashboard" src="https://github.com/user-attachments/assets/ba26ba1b-5de2-4669-8841-92600b41e187" />
...
## Key Insights
- Quarter 4 generated the highest sales, indicating strong seasonal demand  
- Sales showed consistent growth over time, with a noticeable increase in 2013  
- Mountain Bikes emerged as the top-performing products, contributing significantly to overall revenue  
- Monthly sales trends revealed fluctuations, highlighting peak and low-performing periods  
- Product cost and sales trends indicate variations in profitability across time periods  
